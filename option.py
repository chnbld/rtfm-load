...
parser.add_argument('--pretrained-ckpt', default='ckpt/deepmil7460-i3d.pkl', help='ckpt for pretrained model')
...
parser.add_argument('--max-epoch', type=int, default=7540, help='maximum iteration to train (default: 100)')
