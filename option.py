...
parser.add_argument('--rgb-list', default='list/ca-train.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/ca-test.list', help='list of test rgb features ')
...
parser.add_argument('--pretrained-ckpt', default='deepmil2410-i3d.pkl', help='ckpt for pretrained model')
parser.add_argument('--num-classes', type=int, default=1, help='number of class')
parser.add_argument('--dataset-name', default='Shanghai-Tech', help='dataset to train on (default: )')
